...
#     url(r'^delete-todo/(?P<todo_id>\d+)$', 'travelpad.views_itinerary.delete_todo', name = 'delete-todo'),
    ...
    url(r'^message-json/(?P<message_id>\d+)$', 'travelpad.views_itinerary.message_id_json', name = 'message-id-json'),
    url(r'^reply-json$', 'travelpad.views_itinerary.reply_json', name = 'reply-json'),
    url(r'^reply-json/(?P<reply_id>\d+)$', 'travelpad.views_itinerary.reply_id_json', name = 'reply-id-json'),
